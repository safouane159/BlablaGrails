...
//grails.plugin.springsecurity.requestMap.className = 'com.mbds.grails.UserRole'
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	...
	[pattern: '/app-assets/**',   access: ['permitAll']],

	[pattern: '/fonts/**',   access: ['permitAll']],
	[pattern: '/ComingSoon/hello',   access: ['permitAll']],
	[pattern: '/acceuil/index',   access: ['permitAll']],
	[pattern: '/acceuil/details',   access: ['permitAll']],
	[pattern: '/dbconsole/**',   access: ['permitAll']],
	[pattern: '/**/favicon.ico', access: ['permitAll']],
	[pattern: '/**', access: ['permitAll']],
	[pattern: '/annonce/delete/', access: ['permitAll']],
	[pattern: '/Uploader/**', access: ['permitAll']]
