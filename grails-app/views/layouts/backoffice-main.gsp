            ...
            <div class="nav-wrapper">
                ...
                <ul class="navbar-list right">
                    ...
                    <sec:ifNotLoggedIn>
                        <li class="hide-on-med-and-down"><a
                                class="waves-effect waves-block waves-light toggle-fullscreen"
                                href="javascript:void(0);"><g:link controller='login' action='auth'>Login</g:link></a>
                        </li>
                ...
                <ul class="dropdown-content" id="profile-dropdown">
                    <li><a class="grey-text text-darken-1" href="/user/edit"><i
...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
    <div class="brand-sidebar centric">
        <a href="/">
            <g:img dir="images" file="logo-blue.png" width="120" height="60"/></a>
    </div>
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out"
        data-menu="menu-navigation" data-collapsible="accordion">

        <sec:ifAllGranted roles='ROLE_ADMIN'>
            <li class="active bold"><a class="waves-effect waves-cyan" href="/admin/dashboard"><i
                    class="material-icons">settings_input_svideo</i><span class="menu-title"
                                                                   data-i18n="Dashboard">Dashboard</span></a>
            <li
                    class="active bold"><a class="waves-effect waves-cyan" href="/admin/users"><i
                    class="material-icons">person_outline</i><span class="menu-title"
                                                                   data-i18n="Dashboard">Utilisateurs</span></a>
            </li>
            <li class="active bold"><a class="waves-effect waves-cyan" href="/admin/annonces"><i
                    class="material-icons">content_paste</i><span class="menu-title"
                                                                  data-i18n="Dashboard">Annonces</span></a>
            </li>
        </sec:ifAllGranted>
        <sec:ifAllGranted roles='ROLE_CLIENT'>
            <li class="active bold"><a class="waves-effect waves-cyan" href="/acceuil/index"><i
                    class="material-icons">home</i><span class="menu-title"
                                                         data-i18n="Dashboard">Acceuil</span></a>
            </li>
            <li class="active bold"><a class="waves-effect waves-cyan" href="/admin/annonces"><i
                    class="material-icons">content_paste</i><span class="menu-title"
                                                                  data-i18n="Dashboard">Mes annonces</span></a>
            </li>
        </sec:ifAllGranted>
